...
let primeiroLutador: Lutador = new Lutador("Bernardo", 10, 2)
let segundoLutador: Lutador = new Lutador("Tite", 10, 1)

NomeDoVencedor(primeiroLutador, segundoLutador, "Tite")

function NomeDoVencedor(primeiroLutador:Lutador, segundoLutador:Lutador, primeiroAtacar: string): void {
